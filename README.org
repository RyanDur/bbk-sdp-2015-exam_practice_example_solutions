...
*** Most of the method signatures are correct. Some will need to be changed a little to work like the API. (HINT: these are towards the end. Not all of the methods are defined in List, look at the ancestors)
-----
